    ...
    <body id="app" class="antialiased flex col">
        ...
        @if (Route::has('login'))
                ...
                <button class="group col-span-7 flex hover:bg-gray-100 mx-4 my-2 py-3 rounded-md">
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6 mx-3 group-hover:scale-125 duration-200">
                ...
                <a role="button" href="https://www.threads.net" class="group col-span-7 row-span-10 flex hover:bg-gray-100 mx-4 py-3 rounded-md">
                    ...
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="invisible flex-1 w-6 h-6 m-auto pl-32 group-hover:visible ">
                        <path stroke-linecap="round" color="grey" stroke-linejoin="round" d="M13.5 6H5.25A2.25 2.25 0 0 0 3 8.25v10.5A2.25 2.25 0 0 0 5.25 21h10.5A2.25 2.25 0 0 0 18 18.75V10.5m-10.5 6L21 3m0 0h-5.25M21 3v5.25" />
                    </svg>
                </a>
